...
# @Last modified time: 2021-09-21T23:12:05+08:00
# @License: GPL
...
version:
	...
	@echo '#define BUILD_DATETIME "$(COMPILE_TIME)" ' >> $(PWD)/include/version.h
	@echo '#define BUILD_VERSION "$(GIT_REVISION)" ' >> $(PWD)/include/version.h
